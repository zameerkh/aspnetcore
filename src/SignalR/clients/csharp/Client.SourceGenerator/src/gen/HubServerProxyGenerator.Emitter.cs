        ...
        public class Emitter
        {
            ...
            private void EmitExtensions()
            {
                ...
                foreach (var classSpec in _spec.Classes)
                {
                    ...
                    getProxyBody.Append($@"{indentation}if (typeof({_spec.GetterTypeParameterName}) == typeof({fqIntfTypeName}))
{indentation}{{
{indentation}    return ({_spec.GetterTypeParameterName}) ({fqIntfTypeName}) new {fqClassTypeName}({_spec.GetterHubConnectionParameterName});
{indentation}}}");
                }
